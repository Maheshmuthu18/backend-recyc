# Generated by Django 5.1 on 2024-12-06 13:50
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='CustomUser.user')),
            ],
        ),
        migrations.CreateModel(
            name='DealerProfile',
            fields=[
                ...
                ('user', models.OneToOneField(limit_choices_to={'role': 'DEALER'}, on_delete=django.db.models.deletion.CASCADE, to='CustomUser.user')),
            ],
        ),
        migrations.CreateModel(
            name='AdminProfile',
            fields=[
                ...
                ('user', models.OneToOneField(limit_choices_to={'role': 'ADMIN'}, on_delete=django.db.models.deletion.CASCADE, to='CustomUser.user')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.OneToOneField(limit_choices_to={'role': 'USER'}, on_delete=django.db.models.deletion.CASCADE, to='CustomUser.user')),
            ],
        ),
    ]
